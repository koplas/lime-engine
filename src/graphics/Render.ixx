...
struct FrameData {
    ...
    AllocatedBuffer lighting_buffer;
...
private:
    ...
    void init_device() {
        ...
        assert_true(found_queue_family);
    ...
    void init_swapchain() {
        ...
        auto vma_result = vmaCreateImage(m_allocator, std::bit_cast<VkImageCreateInfo const *>(&cimg_info), &alloc_info,
                                         ...
                                         nullptr);
        vk_assert(std::bit_cast<vk::Result>(vma_result));
